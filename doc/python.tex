...
The \lstinline{knotoID_cpp} module exposes the underlying C++ classes. It is useful when working directly with knot(oid) diagrams, for instance to load a diagram from a PD code and compute one of its invariants.
